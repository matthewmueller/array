...
/**
 * Assert that some of the invocations of `fn(val, i)` are truthy.
 *
 * For example ensuring that some pets are admins:
 *
 *    pets.some(function(p){ return p.admin })
 *    pets.some('admin')
 *
 * @param {Function|String} fn
 * @return {Boolean}
